export const fallbackSettings = {
  general: {
    ...
    googleMapsUrl: 'https://maps.google.com/?q=Houston,TX',
    noticeBanner: {
      enabled: true,
  ...
  hero: {
    ...
    subheadline:
      'Fuel up with Top Tier™ Petrol gasoline, grab barista-brewed coffee and fresh deli bites, and save up to 25¢/gal with the Fuel Forward® app.',
    stats: [
  ...
  contact_page_cms: {
    ...
    formSettings: {
      optInText:
        'Sign up for email updates from S&B Retail and a chance to win $500 in promo items and fuel cards each quarter.',
      disclaimerText:
